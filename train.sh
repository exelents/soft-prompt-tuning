...
./finetune_trainer.py --model_name_or_path "" --base_model_path "/export/data/gptj/j6b_ckpt" --output_dir output_dir --adam_eps 1e-06 \
--data_dir "/export/WebNLG/webnlg-dataset/" --do_train --evaluation_strategy=steps  --freeze_embeds --label_smoothing 0 \
--n_prompt_tokens 50 --n_prompts 2 --learning_rate 1e-01 --weight_decay 0.0 --logging_first_step --logging_steps 10 --max_source_length 512 \
